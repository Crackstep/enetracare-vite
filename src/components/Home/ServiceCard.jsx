...
function ServiceCard({ img, text }) {
    ...
    return (
        <div
            ...
            <div className="relative p-6 px-6 py-14 md:px-12" id='service-card-text-container'>
                <h2 className="mb-6 block font-sans text-3xl font-medium leading-[1.5] tracking-normal text-white antialiased" id='service-card-title'>
                    {title}
                </h2>
