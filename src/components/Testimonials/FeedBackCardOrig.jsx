...
function FeedBackCardOrig({
    ...
    return (
        <div className='flex items-center shadow-lg p-6 rounded-lg bg-white m-1 gap-8 hover:bg-[#017F98] hover:text-white hover:duration-300 hover:scale-[1.03] animation' id='feedback-box'>
